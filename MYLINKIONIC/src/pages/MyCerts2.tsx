...
const MyCerts2 = ({ navigation }) => {
  useEffect(() => {
    const resetAction = CommonActions.reset({
      index: 0
      //routes: [{ name: 'MyCerts2' }], // Specify the route name here
    });
      ...
      <IonHeader>
	   ...
	   <IonButton routerLink="/Help"> 
		<IonIcon slot="icon-only" icon={helpSharp}></IonIcon>
          ...
          <IonTitle text-right>CockyEnterprises - Certs</IonTitle>
        </IonToolbar>
      </IonHeader>

      <IonContent fullscreen>
        <IonHeader collapse="condense">
          <IonToolbar color = "danger"><IonTitle>CockyEnterprises - MyCertifications</IonTitle>
           </IonToolbar>
        </IonHeader>
        <Iframe url="https://www.590team1.info/mycerts.html"
        width="100%"
        height="1200px"
        id=""
        className=""
